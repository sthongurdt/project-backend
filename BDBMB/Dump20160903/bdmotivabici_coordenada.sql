...
CREATE TABLE `coordenada` (
  ...
  `hor_tom` time(6) NOT NULL,
  `lat` float NOT NULL,
  `long` float NOT NULL,
  `alt` float NOT NULL,
  PRIMARY KEY (`id_recor`,`hor_tom`),
  CONSTRAINT `id_recor` FOREIGN KEY (`id_recor`) REFERENCES `recorrido` (`id_recor`) ON DELETE NO ACTION ON UPDATE NO ACTION
